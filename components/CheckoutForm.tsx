...
type SubmitResult={ok:boolean;persisted?:boolean;number?:number|null;error?:string}
...
export function CheckoutForm(){
 ...
 async function submit(e:React.FormEvent<HTMLFormElement>){
   e.preventDefault(); if(!store.lines.length){setError('Добавьте хотя бы один ящик в корзину.');return}
